      ...
      <div class="modal-body row">
        ...
        <div class="form-group col-6">
          <div class="col-sm-12">
            ...
            <input type="number" value="<?= $result->price; ?>" name="price" class="form-control"
        ...
        <div class="form-group col-6">
          <div class="col-sm-12">
            ...
            <input type="number" min="0" name="weight" oninput="validity.valid||(value='');" step="0.5"
              value="<?= $result->weight; ?>" class="form-control" placeholder="Enter weight">
          </div>
        </div>
        <div class="form-group col-6">
          <div class="col-sm-12">
            <label for="text">Đánh giá(1-5): </label>
            <input type="number" name="vote" value="<?= $result->vote; ?>" class="form-control" min="1" max="5"
        ...
        <div class="form-group col-6">
          <div class="col-sm-12">
            ...
            <input type="text" name="desc" value="<?= $result->description; ?>" class="form-control"
              placeholder="Enter name">
          </div>
        </div>
        <div class="form-group col-6">
